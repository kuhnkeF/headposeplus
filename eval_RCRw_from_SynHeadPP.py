# use RCRw trained on SynHead++ to evaluate on Biwi variants
...
# paths
result_path = 'results/RCRwSynHeadPP/'
model_path_A = 'models/RCRw_from_SynheadPP_F.tar'
model_path_B = 'models/RCRw_from_SynheadPP_T.tar'
